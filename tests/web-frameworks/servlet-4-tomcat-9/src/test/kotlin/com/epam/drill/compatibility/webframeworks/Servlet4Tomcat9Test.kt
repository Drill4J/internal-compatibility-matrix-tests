...
import com.epam.drill.compatibility.apps.SimpleHttpServlet4
...
class Servlet4Tomcat9Test: WebServerMatrixTest() {
    ...
    override fun getClassUnderTest() = SimpleHttpServlet4::class.java
