...
@ContextConfiguration(classes = [SpringWsClient1JettyTest.TestWebSocketClientConfig::class])
class SpringWsClient1JettyTest : SpringMVCWebSocketClientMatrixTest() {
