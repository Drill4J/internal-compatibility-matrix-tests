...
@ContextConfiguration(classes = [SpringWs1JettyWsClientTest.TestWebSocketClientConfig::class])
class SpringWs1JettyWsClientTest : SpringMVCWebSocketClientMatrixTest() {
