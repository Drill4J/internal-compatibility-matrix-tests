...
@ContextConfiguration(classes = [SpringWs3UndertowWsClientTest.TestWebSocketClientConfig::class])
class SpringWs3UndertowWsClientTest : SpringMVCWebSocketClientMatrixTest() {
