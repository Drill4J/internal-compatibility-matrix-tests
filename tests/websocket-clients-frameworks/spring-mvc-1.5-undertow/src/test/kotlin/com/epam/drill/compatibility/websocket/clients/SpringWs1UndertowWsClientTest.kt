...
@ContextConfiguration(classes = [SpringWs1UndertowWsClientTest.TestWebSocketClientConfig::class])
class SpringWs1UndertowWsClientTest : SpringMVCWebSocketClientMatrixTest() {
