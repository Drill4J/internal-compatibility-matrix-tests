...
@ContextConfiguration(classes = [SpringWebflux2JettyWsClientTest.TestWebSocketClientConfig::class])
class SpringWebflux2JettyWsClientTest : SpringWebfluxWebSocketClientMatrixTest() {
