...
@ContextConfiguration(classes = [SpringWsClient2UndertowTest.TestWebSocketClientConfig::class])
class SpringWsClient2UndertowTest : SpringMVCWebSocketClientMatrixTest() {
