...
@ContextConfiguration(classes = [SpringWs2JettyWsClientTest.TestWebSocketClientConfig::class])
class SpringWs2JettyWsClientTest : SpringMVCWebSocketClientMatrixTest() {
