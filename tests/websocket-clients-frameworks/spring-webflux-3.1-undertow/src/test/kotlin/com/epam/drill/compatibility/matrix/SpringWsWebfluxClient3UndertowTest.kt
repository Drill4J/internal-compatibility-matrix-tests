...
@ContextConfiguration(classes = [SpringWsWebfluxClient3UndertowTest.TestWebSocketClientConfig::class])
class SpringWsWebfluxClient3UndertowTest : SpringWebfluxWebSocketClientMatrixTest() {
