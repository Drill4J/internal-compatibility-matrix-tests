...
@ContextConfiguration(classes = [SpringWebflux3UndertowWsClientTest.TestWebSocketClientConfig::class])
class SpringWebflux3UndertowWsClientTest : SpringWebfluxWebSocketClientMatrixTest() {
