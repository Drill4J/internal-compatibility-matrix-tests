...
@ContextConfiguration(classes = [SpringWs3JettyWsClientTest.TestWebSocketClientConfig::class])
class SpringWs3JettyWsClientTest : SpringMVCWebSocketClientMatrixTest() {
