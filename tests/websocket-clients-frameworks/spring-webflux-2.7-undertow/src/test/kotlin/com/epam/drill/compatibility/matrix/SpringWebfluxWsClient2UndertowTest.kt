...
@ContextConfiguration(classes = [SpringWebfluxWsClient2UndertowTest.TestWebSocketClientConfig::class])
class SpringWebfluxWsClient2UndertowTest : SpringWebfluxWebSocketClientMatrixTest() {
