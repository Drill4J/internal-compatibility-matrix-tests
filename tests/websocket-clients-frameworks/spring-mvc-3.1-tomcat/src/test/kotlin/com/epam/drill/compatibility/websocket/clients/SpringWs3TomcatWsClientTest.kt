...
@ContextConfiguration(classes = [SpringWs3TomcatWsClientTest.TestWebSocketClientConfig::class])
class SpringWs3TomcatWsClientTest : SpringMVCWebSocketClientMatrixTest() {
