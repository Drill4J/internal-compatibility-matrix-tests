...
@ContextConfiguration(classes = [SpringWebflux2JettyWsMessageTest.TestWebSocketClientConfig::class])
class SpringWebflux2JettyWsMessageTest : SpringWebfluxWebSocketMessagesMatrixTest() {
