...
@ContextConfiguration(classes = [SpringWebfluxWsMessages2JettyTest.TestWebSocketClientConfig::class])
class SpringWebfluxWsMessages2JettyTest : SpringWebfluxWebSocketMessagesMatrixTest() {
