...
@ContextConfiguration(classes = [SpringWsWebfluxMessages2JettyTest.TestWebSocketClientConfig::class])
class SpringWsWebfluxMessages2JettyTest : SpringWebfluxWebSocketMessagesMatrixTest() {
