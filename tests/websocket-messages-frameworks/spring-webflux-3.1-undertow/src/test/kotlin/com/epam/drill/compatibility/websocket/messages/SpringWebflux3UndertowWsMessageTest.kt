...
@ContextConfiguration(classes = [SpringWebflux3UndertowWsMessageTest.TestWebSocketClientConfig::class])
class SpringWebflux3UndertowWsMessageTest : SpringWebfluxWebSocketMessagesMatrixTest() {
