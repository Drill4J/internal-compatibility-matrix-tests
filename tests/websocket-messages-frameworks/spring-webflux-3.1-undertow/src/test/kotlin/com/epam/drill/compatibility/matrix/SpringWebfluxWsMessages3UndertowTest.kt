...
@ContextConfiguration(classes = [SpringWebfluxWsMessages3UndertowTest.TestWebSocketClientConfig::class])
class SpringWebfluxWsMessages3UndertowTest : SpringWebfluxWebSocketMessagesMatrixTest() {
