...
@ContextConfiguration(classes = [SpringWebflux3TomcatWsMessageTest.TestWebSocketClientConfig::class])
class SpringWebflux3TomcatWsMessageTest : SpringWebfluxWebSocketMessagesMatrixTest() {
