...
@ContextConfiguration(classes = [SpringWebflux2TomcatWsMessageTest.TestWebSocketClientConfig::class])
class SpringWebflux2TomcatWsMessageTest : SpringWebfluxWebSocketMessagesMatrixTest() {
