...
@ContextConfiguration(classes = [SpringWebflux3JettyWsMessageTest.TestWebSocketClientConfig::class])
class SpringWebflux3JettyWsMessageTest : SpringWebfluxWebSocketMessagesMatrixTest() {
