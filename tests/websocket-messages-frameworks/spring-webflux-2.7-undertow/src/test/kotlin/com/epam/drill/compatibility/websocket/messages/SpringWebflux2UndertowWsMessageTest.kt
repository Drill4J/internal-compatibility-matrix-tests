...
@ContextConfiguration(classes = [SpringWebflux2UndertowWsMessageTest.TestWebSocketClientConfig::class])
class SpringWebflux2UndertowWsMessageTest : SpringWebfluxWebSocketMessagesMatrixTest() {
