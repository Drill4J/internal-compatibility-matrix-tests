...
class CompatibilityMatrixTest : JavaxWebSocketClientMatrixTest() {

    override fun connectToWebsocketAnnotatedEndpoint(endpoint: String) = TestRequestAnnotatedClientEndpoint().run {
        val session = JavaxWebSocketClientContainerProvider.getWebSocketContainer().connectToServer(this, URI(endpoint))
        this to session
    }
