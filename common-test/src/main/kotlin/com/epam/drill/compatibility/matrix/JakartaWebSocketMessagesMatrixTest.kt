...
abstract class JakartaWebSocketMessagesMatrixTest : AbstractWebSocketMessagesTest() {
    ...
    interface JakartaTestRequestEndpoint : TestRequestEndpoint {
    ...
    class TestRequestServerAnnotatedEndpoint : JakartaTestRequestEndpoint {
    ...
    class TestRequestServerInterfaceEndpoint : Endpoint(), JakartaTestRequestEndpoint {
        override val incomingMessages = TestRequestEndpoint.incomingMessages
        override val incomingContexts = TestRequestEndpoint.incomingContexts
    ...
    @Suppress("unused")
    @ClientEndpoint
    class TestRequestClientAnnotatedEndpoint : JakartaTestRequestEndpoint {
    ...
    class TestRequestClientInterfaceEndpoint : Endpoint(), JakartaTestRequestEndpoint {
        override val incomingMessages = mutableListOf<String>()
        override val incomingContexts = mutableListOf<DrillRequest?>()
        override fun onOpen(session: Session, config: EndpointConfig) = try {
    ...
    ) : MessageHandler.Whole<String>, JakartaTestRequestEndpoint {
    ...
    private class ServerBinaryMessageHandler(
        ...
        override val incomingMessages: MutableList<String>,
        override val incomingContexts: MutableList<DrillRequest?>
    ) : MessageHandler.Whole<ByteBuffer>, JakartaTestRequestEndpoint {
