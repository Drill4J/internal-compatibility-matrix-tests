...
@SpringBootTest(classes = [SpringMVCWebSocketClientMatrixTest.TestWebSocketConfig::class])
open class SpringMVCWebSocketClientMatrixTest : AbstractWebSocketServerTest() {
